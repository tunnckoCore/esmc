...
> Modern JavaScript, today. Blazingly fast zero-config compiler/language built on @babel and @eslint, with optional support for @flowtype
...
- Babel config is basically externalized as [babel-config-esmc][]
...
[dependencies-img]: https://badgen.net/david/dep/olstenlarck/esmc
